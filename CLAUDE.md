...
- `ergo-reminder-analyse.hta` → VERSION in Zeile ~18 (aktuell **1.8**, JScript-COM; zaehlt Erinnerungs-Mails von JDC/Jung DMS aus bis zu 2 Ordnern je Eingangskanal, mit Sparte aus VNR-Praefix)
...
(aktuell **12.07**). **Bei JEDER Aenderung im Repo MUSS diese hochgezaehlt werden**,
