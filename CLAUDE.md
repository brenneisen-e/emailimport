...
- `ergo-reminder-analyse.hta` → VERSION in Zeile ~18 (aktuell **1.1**, JScript-COM; zaehlt Erinnerungs-Mails von JDC/Jung DMS aus bis zu 2 Ordnern je Eingangskanal, mit Sparte aus VNR-Praefix)
