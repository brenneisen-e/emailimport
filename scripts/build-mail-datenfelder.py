...
from datenfelder import (ABSCHNITTE, ALLE_FELDER, BITTE, EINLEITUNG, NUMMERN_SCHLUSS,
                         NUMMERN_SCHRITTE, NUMMERN_TEXT, OFFEN, PRUEFUNG, SCHLUSS,
...
teile.append("<p>%s</p>" % NUMMERN_SCHLUSS)
...
for i, b in enumerate(NUMMERN_SCHRITTE, 1):
    zeilen.append("  %d. %s" % (i, umbruch(rein(b), 70, "     ")))
zeilen += ["", umbruch(rein(NUMMERN_SCHLUSS)), ""]
